...
https://github.com/Vipul12Thawre/JetCapture/blob/main/app/src/main/java/com/vips/jetcapture/utils/ShareUtils.kt
 */
...
class ShareUtils {
    ...
    companion object{
        private fun saveBitmapAndGetUri(context: Context, bitmap: Bitmap): Uri? {
            val path: String = context.externalCacheDir.toString() + "/lastShare.jpg"
            ...
            return FileProvider.getUriForFile(
                context, context.packageName + ".com.yquery.quote_of_the_day.file-provider", file
            )
        }
